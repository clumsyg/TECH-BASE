...
<!-- bingに聞いたら、css, javascriptを使ってできた -->
<!-- 182行目以降 -->
...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="input-container">
            <input type="password" id="pw" name="pw" placeholder="パスワード">
            <img src="eye_icon.png" id="togglePassword">    <!-- eye_iconという名前で好きな目の画像をローカルでダウンロードし、このエディタ上でそのファイルをアップロードする必要がある -->
        </div>
